...
class Voc2007Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None, inp_name=None, adj=None):
        ...
        self.path_images = os.path.join(root, 'VOCdevkit', 'VOC2007', 'JPEGImages')  # root/VOCdevkit/VOC2007/JPEGImages
        self.set = set  # set为需要读取的txt文件类型
        self.transform = transform  # transform转换
        ...
        path_csv = os.path.join('./files', 'VOC2007')
        ...
        if not os.path.exists(file_csv):
            ...
            # generate csv file
            labeled_data = read_object_labels(self.root, 'VOC2007', self.set)  # 读取标签值
            # write csv file
